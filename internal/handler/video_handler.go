...
func NewVideoHandler(videoService *service.VideoService, accountService *service.AccountService) *VideoHandler {
	return &VideoHandler{service: videoService, accountService: accountService}
}

func (vh *VideoHandler) PublishVideo(c *gin.Context) {
	var req model.PublishVideoRequest
	...
	account, err := vh.accountService.FindByID(c.Request.Context(), authorId)
	if err != nil {
		c.JSON(400, gin.H{"error": err.Error()})
		return
	}
...
func (vh *VideoHandler) DeleteVideo(c *gin.Context) {
	var req model.DeleteVideoRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(400, gin.H{"error": err.Error()})
		return
	}
...
func (vh *VideoHandler) ListByAuthorID(c *gin.Context) {
	var req model.ListByAuthorIDRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(400, gin.H{"error": err.Error()})
		return
	}
...
func (vh *VideoHandler) GetDetail(c *gin.Context) {
	var req model.GetDetailRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(400, gin.H{"error": err.Error()})
		return
	}
...
func (vh *VideoHandler) UpdateLikesCount(c *gin.Context) {
	var req model.UpdateLikesCountRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(400, gin.H{"error": err.Error()})
		return
	}
